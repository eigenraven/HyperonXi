...
; The multiboot 2 header
	...
	pstubentry:
		...
		mov ecx, 0xC0000080 ; Enable SYSCALL/SYSRET & long mode & NX bit
		rdmsr
		bts eax,11
		bts eax, 8
		bts eax, 0
...
bits 64
	...
	align 4096
	p4_base:
		dq (p3_base + 0x7) ; 0x0 identity mapping
		times 255 dq 0
		dq (p3_base + 0x7) ; 0xffff800000000000
		times 127 dq 0
		dq (p3_base + 0x7) ; 0xffffc00000000000
		times 127 dq 0
	; P3
	align 4096
	p3_base:
